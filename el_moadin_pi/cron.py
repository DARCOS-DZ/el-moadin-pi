...
def daily():
    ...
    # config.alaicha = "13:30:30"
    config.alaicha = prayers["alaicha"]

    # verify if deadline have been crossed
    ...
    if elfajer_dif.total_seconds() < 0 :
        pass
    elif elfajer_dif.total_seconds() < 600 and config.elfajer_schedul == False :
    ...
    if duhr_dif.total_seconds() < 0 :
        pass
    elif duhr_dif.total_seconds() < 600 and config.duhr_schedul == False :
    ...
    if alasr_dif.total_seconds() < 0 :
        pass
    elif alasr_dif.total_seconds() < 600 and config.alasr_schedul == False :
    ...
    if almaghreb_dif.total_seconds() < 0 :
        pass
    elif almaghreb_dif.total_seconds() < 600 and config.almaghreb_schedul == False :
    ...
    if alaicha_dif.total_seconds() < 0 :
        pass
    elif alaicha_dif.total_seconds() < 600 and config.alaicha_schedul == False :
